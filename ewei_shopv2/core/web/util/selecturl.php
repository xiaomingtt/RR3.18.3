...
class Selecturl_EweiShopV2Page extends WebPage
{
	...
	public function main()
	{
		...
		if ($platform) {
            ...
            $allUrls[0]["list"][] = array('name' => '商户展示', 'url_wxapp' => '/pages/wemecms/merch/index');
            $allUrls[0]['list'][] = array('name' => '商户申请', 'url' => mobileUrl('', NULL, $full), 'url_wxapp' => '/pages/wemecms/merch/apply');
