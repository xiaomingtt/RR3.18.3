...
CREATE TABLE `ims_ewei_shop_goods` (
  ...
  `zq_Id` varchar(20) NOT NULL DEFAULT '',
  `zq_Id02` varchar(20) NOT NULL DEFAULT '',
  `zq_Source` varchar(20) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_pcate` (`pcate`),
  KEY `idx_ccate` (`ccate`),
  ...
  KEY `zq_Id` (`zq_Id`) USING BTREE,
  KEY `zq_Id02` (`zq_Id02`) USING BTREE,
  KEY `zq_Source` (`zq_Source`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `ims_ewei_shop_perm_log` VALUES ('1', '1', '1', '设置-商城设置-修改', 'sysset.shop.edit', '修改系统设置-商城设置', '182.133.36.97', '1585020095');
INSERT INTO `ims_ewei_shop_perm_log` VALUES ('2', '1', '1', '设置-商城设置-修改', 'sysset.shop.edit', '修改系统设置-商城设置', '182.133.36.97', '1585020480');
INSERT INTO `ims_ewei_shop_perm_log` VALUES ('3', '1', '1', '会员管理-会员等级-修改', 'member.level.edit', '修改会员默认等级<br/>等级名称: ->默认会员<br/>折扣: ->', '182.133.36.97', '1585020599');
...
CREATE TABLE `ims_ewei_shop_queue` (
  ...
  KEY `channel` (`channel`(191)) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
